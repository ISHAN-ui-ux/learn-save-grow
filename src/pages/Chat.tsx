    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="w-16 bg-white border-r border-gray-200 flex flex-col items-center py-4 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <Button variant="ghost" size="icon" className="w-10 h-10 rounded-lg bg-blue-50">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="h-14 bg-white border-b border-gray-200 flex items-center justify-center">
          <h1 className="text-xl font-semibold text-gray-800">Finance Assistant</h1>
        </div>
                          ...
                          <div className="prose prose-sm max-w-none text-gray-900">
                            <ReactMarkdown 
                              ...
                              components={{
                                ...
                                blockquote: ({children}) => <blockquote className="border-l-4 border-blue-500 pl-4 mb-4 text-gray-700 italic">{children}</blockquote>,
          ...
          <div className="p-4 bg-white border-t border-gray-200">
            <div className="max-w-3xl mx-auto">
              <div className="relative">
                <div className="flex items-center space-x-2 bg-white border border-gray-300 rounded-xl px-4 py-3 focus-within:border-blue-500 focus-within:ring-1 focus-within:ring-blue-500">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["Budget planning", "Investment strategy", "Business advice", "Debt management"].map((topic) => (
                      <Button
                        ...
                        variant="outline"
                        size="sm"
                        className="h-7 px-3 text-xs border-gray-300 hover:bg-blue-50 hover:border-blue-300"
